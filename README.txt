...
If the person you are chatting with has replied already, you will see their message will be returned.  If they haven't replied yet, nothing will be returned.  You can always try the above command again after waiting a few more moments, or set up a process that runs in a loop to query for replies.  
